...
<head>
    ...
    <!-- Gordita Fonts CSS -->
    <link rel="stylesheet" href="{{ asset('frontend/fonts/gordita-fonts.css')}}" />

    <!-- Icofont CSS -->
    <link rel="stylesheet" href="{{ asset('frontend/css/vendor/icofont.min.css')}}" />
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8">
                        ...
                        <div class="logo">
                            <a href="index.html">
                                <img src="{{asset('frontend/images/logo/logo.png')}}" class="img-fluid" alt="">
                            </a>
                        </div>
                    </div>
...
<!-- Light gallery JS -->
<script src="{{asset('frontend/js/plugins/lightgallery.min.js')}}"></script>

<!-- Isotope JS -->
<script src="{{asset('frontend/js/plugins/isotope.min.js')}}"></script>

<!-- Masonry JS -->
<script src="{{asset('frontend/js/plugins/masonry.min.js')}}"></script>

<!-- ImagesLoaded JS -->
<script src="{{asset('frontend/js/plugins/images-loaded.min.js')}}"></script>
...
<!-- Plugins JS (Please remove the comment from below plugin')}}s.min.js for better website load performance and remove plugin js files from avobe) -->
