                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="blog-details-post-image mt-5  mb-5">
                            <img src="{{ asset('frontend/images/blog/blog-details-2.jpg') }}" alt="">
                        </div>
                        ...
                        <div class="blog-details-two-post-text section-space--pb_80">
                            <div class="col-lg-10 m-auto">
                                ...
                                <div class="blog-details-image mt-5  mb-5">
                                    <img src="{{ asset('frontend/images/blog/blog-details-3.jpg') }}" alt="">
                                </div>
                ...
                <div class="swiper-container related-post-two-slider-active">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div class="single-most-populer-item">
                                <a href="#!" class="most-populer-thum">
                                    <img src="{{ asset('frontend/images/banners/02-special-banner.jpg') }}" alt="">
                                </a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-most-populer-item">
                                <a href="#!" class="most-populer-thum">
                                    <img src="{{ asset('frontend/images/banners/03-special-banner.jpg') }}" alt="">
                                </a>
                                <div class="most-populer-content">
                                    <div class="most-populer-post-author">
                                        By <a href="#">Andrew Hoffman</a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="single-most-populer-item">
                                <a href="#!" class="most-populer-thum">
                                    <img src="{{ asset('frontend/images/banners/04-special-banner.jpg') }}" alt="">
                                </a>
                                <div class="most-populer-content">
                                    <div class="most-populer-post-author">
                                        By <a href="#">Andrew Hoffman</a>
                                    ...
                                    <div class="comment-2">
                                        <div class="comment-author-info">
                                            <div class="comment-author vcard">
                                                <img alt="" src="{{ asset('frontend/images/comments/comments-1.png') }}">
                                            </div>
                                                ...
                                                <div class="meta">
                                                    <div class="comment-content-top">
                                                        <div class="comment-actions">
                                                            ...
                                                            <div class="comment-datetime"> Product Designer, USA </div> <span class="separator">||</span> <span class="time">35 minutes ago </span>
                                                        </div>
                                                    </div>
                                    ...
                                    <ol class="children">
                                        <li class="comment ">
                                            <div class="comment-reply-wrap">
                                                <div class="comment-author-info">
                                                    <div class="comment-author vcard">
                                                        <img alt="" src="{{ asset('frontend/images/comments/comments-2.png') }}">
                                                    </div>
                                                    <div class="comment-content">
                                                        <div class="meta">
                                                            <div class="comment-content-top">
                                        ...
                                        <li class="comment ">
                                            <div class="comment-reply-wrap">
                                                <div class="comment-author-info">
                                                    <div class="comment-author vcard">
                                                        <img alt="" src="{{ asset('frontend/images/comments/comments-3.png') }}">
                                                    </div>
                                                    <div class="comment-content">
                                                        <div class="meta">
                                                            <div class="comment-content-top">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="submit-button text-center">
                                        <button class="btn-large btn-bg-6 btn-primary" type="submit"> Submit Now <i class="icofont-long-arrow-right"></i></button>
                                    </div>
                                </div>
                            </div>
                        </form>
