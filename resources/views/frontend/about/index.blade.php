                        ...
                        <div class="col-lg-12 video-popup">
                            <a href="https://www.youtube.com/watch?v=9No-FiEInLA" class="video-link mt-30">
                                <div class="single-popup-wrap">
                                    <img class="img-fluid" src="{{ asset('frontend/images/banners/about-video-banner.jpg') }}" alt="">
                        ...
                        <div class="col-lg-4">
                            <div class="single-platform-box" data-aos="fade-up">
                                <div class="platform-icon">
                                    <img src="{{ asset('frontend/images/icons/open-platform.png') }}" alt="">
                                </div>
                        ...
                        <div class="col-lg-8">
                            <div class="single-platform-box platform-d-flex">
                                <div class="platform-content-box" data-aos="fade-up">
                                    <div class="platform-icon">
                                        <img src="{{ asset('frontend/images/icons/digital-publishing.png') }}" alt="">
                                    </div>
                                    <div class="platform-content">
                                ...
                                <div class="plateform-image-box" data-aos="fade-up">
                                    <div class="plateforem-image">
                                        <img src="{{ asset('frontend/images/banners/about-ex-share.jpg') }}" alt="">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            ...
                            <div class="single-team-area" data-aos="fade-up">
                                <div class="team-thum">
                                    <img src="{{ asset('frontend/images/team/team-1.jpg') }}" alt="">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                            ...
                            <div class="single-team-area">
                                <div class="team-thum">
                                    <img src="{{ asset('frontend/images/team/team-3.jpg') }}" alt="">
                                </div>
                                <div class="team-content">
                                    <div class="team-share-top">
                                        <a href="#" class="shate-action-button"><i class="icofont-close"></i></a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                            ...
                            <div class="single-team-area">
                                <div class="team-thum">
                                    <img src="{{ asset('frontend/images/team/team-4.jpg') }}" alt="">
                                </div>
                                <div class="team-content">
                                    <div class="team-share-top">
                                        <a href="#" class="shate-action-button"><i class="icofont-close"></i></a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                            ...
                            <div class="single-team-area">
                                <div class="team-thum">
                                    <img src="{{ asset('frontend/images/team/team-5.jpg') }}" alt="">
                                </div>
                                <div class="team-content">
                                    <div class="team-share-top">
                                        <a href="#" class="shate-action-button"><i class="icofont-close"></i></a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                            ...
                            <div class="single-team-area">
                                <div class="team-thum">
                                    <img src="{{ asset('frontend/images/team/team-6.jpg') }}" alt="">
                                </div>
                                <div class="team-content">
                                    <div class="team-share-top">
                                        <a href="#" class="shate-action-button"><i class="icofont-close"></i></a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                            ...
                            <div class="single-team-area">
                                <div class="team-thum">
                                    <img src="{{ asset('frontend/images/team/team-7.jpg') }}" alt="">
                                </div>
                                <div class="team-content">
                                    <div class="team-share-top">
                                        <a href="#" class="shate-action-button"><i class="icofont-close"></i></a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                            ...
                            <div class="single-team-area">
                                <div class="team-thum">
                                    <img src="{{ asset('frontend/images/team/team-8.jpg') }}" alt="">
                                </div>
                                <div class="team-content">
                                    <div class="team-share-top">
                                        <a href="#" class="shate-action-button"><i class="icofont-close"></i></a>
                                ...
                                <div class="swiper-wrapper">
                                        ...
                                        <div class="single-testimonial-item-two" data-aos="fade-up">
                                            <div class="testimonial-post-author">
                                                <div class="testimonial-author-image">
                                                    <img src="{{ asset('frontend/images/author/testimonial-1.png') }}" alt="">
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="single-testimonial-item-two" data-aos="fade-up">
                                            <div class="testimonial-post-author">
                                                <div class="testimonial-author-image">
                                                    <img src="{{ asset('frontend/images/author/testimonial-2.png') }}" alt="">
                                                </div>
                                                <div class="testimonial-author-info">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="single-testimonial-item-two" data-aos="fade-up">
                                            <div class="testimonial-post-author">
                                                <div class="testimonial-author-image">
                                                    <img src="{{ asset('frontend/images/author/testimonial-3.png') }}" alt="">
                                                </div>
                                                <div class="testimonial-author-info">
                                                    <h4>Bansten Smith</h4>
                                                    <p>UI/UX DESIGNER</p>
