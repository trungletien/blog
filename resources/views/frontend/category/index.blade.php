            ...
            <div class="col-12">
                <div class="breadcrumb_box text-center">
                    ...
                    <ul class="breadcrumb-list">
                        ...
                        <li class="breadcrumb-item active">Catagory Grid</li>
                    </ul>
                    <!-- breadcrumb-list end -->
                </div>
            </div>
            ...
            <div class="container">
                <div class="row row--17">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-following-post" data-aos="fade-up">
                            <a href="blog-details.html" class="following-post-thum">
                                <img src="{{ asset('frontend/images/blog/01.jpg') }}" alt="">
                            </a>
                            <div class="following-post-content">
                                ...
                                <div class="following-blog-post-meta">
                                    ...
                                    <div class="post-meta-right-side">
                                        <a href="#"><img src="{{ asset('frontend/images/icons/small-bookmark.png') }}" alt="" /></a>
                                        <a href="#"><img src="{{ asset('frontend/images/icons/heart.png') }}" alt="" /></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-following-post" data-aos="fade-up">
                            <a href="blog-details.html" class="following-post-thum">
                                <img src="{{ asset('frontend/images/blog/04.jpg') }}" alt="">
                            </a>
                            <div class="following-post-content">
                                <div class="following-blog-post-top">
                                    <div class="trending-blog-post-category">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-following-post" data-aos="fade-up">
                            <a href="blog-details.html" class="following-post-thum">
                                <img src="{{ asset('frontend/images/blog/05.jpg') }}" alt="">
                            </a>
                            <div class="following-post-content">
                                <div class="following-blog-post-top">
                                    <div class="trending-blog-post-category">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-following-post" data-aos="fade-up">
                            <a href="blog-details.html" class="following-post-thum">
                                <img src="{{ asset('frontend/images/blog/06.jpg') }}" alt="">
                            </a>
                            <div class="following-post-content">
                                <div class="following-blog-post-top">
                                    <div class="trending-blog-post-category">
